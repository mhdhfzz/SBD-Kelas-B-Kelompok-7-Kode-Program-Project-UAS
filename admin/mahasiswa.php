        ...
        <div class="layout">
            <main class="content">
                ...
                <div class="container">
                    ...
                    <div>
                        <h1><a href="tambah-mhs.php" class=""><i class="ri-add-fill"></i> Add</a></h1>
                    </div>
                </div>
                    ...
                    <table class="table" cellpadding="5" cellspacing="0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="ubah-mhs.php?nim=<?= $data["nim"]; ?>" class="">Edit</a> | <a
                                        href="hapus-mhs.php?nim=<?= $data["nim"]; ?>" class=""
